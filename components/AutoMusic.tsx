...
export default function AutoMusic() {
  ...
  return (
    <>
      ...
      <motion.button
        onClick={toggleMute}
        className="fixed top-6 right-6 z-50 w-14 h-14 rounded-full bg-white/90 backdrop-blur-sm shadow-lg flex items-center justify-center hover:bg-white transition-colors border-2 border-rose-200"
