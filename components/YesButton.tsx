...
export default function YesButton({ onClick }: YesButtonProps) {
  return (
    <motion.button
      onClick={onClick}
      className="relative px-8 py-4 sm:px-10 sm:py-5 md:px-12 md:py-6 text-xl sm:text-2xl md:text-3xl font-bold text-white rounded-full overflow-hidden group"
      style={{
